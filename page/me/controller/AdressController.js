...
app.controller('addressAdm',['$http','$scope','AuthService','$ionicHistory',function($http,$scope,AuthService,$ionicHistory) {
...
var fId;
app.controller('selProvice',['$http','$scope','$ionicHistory',function($http,$scope,history){
    //查找省份地址
    $scope.searchCondition={
        father:true
    };
...
app.controller('selectCity',['$http','$scope','$stateParams','$ionicHistory',function($http,$scope,$stateParams,history){
...
app.controller('selectCounty',['$http','$scope','$stateParams','$ionicHistory',function($http,$scope,$stateParams,history){
   $scope.name= $.trim($stateParams.name);
    $scope.searchCondition={
        father:false,
        fatherid:0

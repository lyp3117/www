app.controller('TabCarCtrl', ['$scope','$state','$ionicHistory','AuthService',  '$ionicSlideBoxDelegate','cartservice','carProduct',function($scope,$state,$ionicHistory,AuthService,  $ionicSlideBoxDelegate,cartservice,carProduct) {
   ...
   var allprice=function(){
    ...
    $scope.jiesuan=function(){
        ...
        else
        {
            ...
            carProduct.set($scope.productcount);//传递page.order
            $state.go("page.order");
...
app.controller('CarDetailCtrl', ['$scope', '$stateParams',function($scope, $stateParams) {

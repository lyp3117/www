...
app.controller('CategoryController',['$scope','$http','$state','$ionicHistory',function($scope,$http,$state,history){
...
//    };
    ...
    $scope.return = function(){
        if(!history.backView())
            $state.go("page.service");
        history.goBack();
        if(history.backView() && history.backView().stateName ==='page.service')
